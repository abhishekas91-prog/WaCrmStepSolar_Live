...
export const RATE_LIMITS = {
  ...
  /** Mark-as-read, per user. Fires once per conversation open plus
   *  once per new inbound message while a thread is already open —
   *  generous headroom for an agent flipping fast through unread
   *  chats. */
