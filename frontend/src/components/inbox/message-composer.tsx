      ...
      <div className="mt-2 flex items-end gap-2">
        ...
        <GatedButton
          ...
          className={cn(
            ...
            "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#008069] dark:bg-[#00a884] hover:bg-[#00705c] text-white p-0 shadow-md disabled:opacity-40 transition-transform active:scale-95",
