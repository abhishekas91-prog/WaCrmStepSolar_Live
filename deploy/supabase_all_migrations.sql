-- ===============================================================
-- Abhiwacrm consolidated Supabase migrations
-- Paste this ENTIRE file into: Supabase Dashboard -> SQL Editor -> New query -> Run
-- Safe to re-run: every migration uses IF NOT EXISTS / OR REPLACE where possible.
-- ===============================================================
...
-- ==== BEGIN 002_pipelines_enhancements.sql ====
-- ============================================================
...
-- ==== BEGIN 003_broadcast_recipient_wamid.sql ====
-- ============================================================
...
-- ==== BEGIN 004_contact_delete_set_null.sql ====
-- ============================================================
...
-- ==== BEGIN 005_broadcast_counts_incremental.sql ====
-- ============================================================
...
-- ==== BEGIN 007_automations_increment_counter.sql ====
-- ============================================================
...
-- ==== BEGIN 008_profile_avatars_storage.sql ====
-- ============================================================
...
-- ==== BEGIN 011_profile_beta_features.sql ====
-- ============================================================
...
-- ==== BEGIN 012_flows_increment_counter.sql ====
-- ============================================================
...
-- ==== BEGIN 013_whatsapp_config_phone_number_id_unique.sql ====
-- ============================================================
...
-- ==== BEGIN 014_message_templates_meta_integration.sql ====
-- ============================================================
...
-- ==== BEGIN 015_whatsapp_config_registration.sql ====
-- ============================================================
...
-- ==== BEGIN 018_account_member_rpcs.sql ====
-- ============================================================
...
-- ==== BEGIN 020_account_sharing_followups.sql ====
-- ============================================================
...
-- ==== BEGIN 021_account_default_currency.sql ====
-- ============================================================
...
-- ==== BEGIN 022_contact_phone_dedup.sql ====
-- ============================================================
...
-- ==== BEGIN 025_filter_contacts_by_tags.sql ====
-- ============================================================
...
-- ==== BEGIN 028_webhook_endpoints.sql ====
-- ============================================================
...
-- ==== BEGIN 031_ai_reply_slot_grant.sql ====
-- ============================================================
...
-- ==== BEGIN 032_fix_ai_knowledge_membership.sql ====
-- ============================================================
...
-- ==== BEGIN 034_fix_profiles_update_rls.sql ====
-- ============================================================
...
-- ==== BEGIN 035_interactive_messages.sql ====
-- ============================================================
...
-- ==== BEGIN 036_conversation_contact_dedup.sql ====
-- ============================================================
...
-- ==== BEGIN 037_webhook_broadcast_reliability.sql ====
-- ============================================================
...
-- ==== END 037_webhook_broadcast_reliability.sql ====
